...
export const register = async (req, res) => res.status(201).json({ success: true, message: 'Attendee registered successfully.', data: { attendee: await attendeeService.registerAttendee(req.body) } });
