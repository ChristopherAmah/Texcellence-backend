...
export const updateRole = async (req, res) => res.json({ success: true, message: 'User role updated successfully.', data: { user: await userService.updateUserRole(req.params.userId, req.body.role, req.user) } });
