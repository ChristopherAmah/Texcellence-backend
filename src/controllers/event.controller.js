...
export const create = async (req, res) => res.status(201).json({ success: true, message: 'Event created successfully.', data: { event: await eventService.createEvent(req.body) } });
