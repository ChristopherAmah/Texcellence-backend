...
const activitySchema = new mongoose.Schema({
  type: { type: String, enum: ['ATTENDEE_REGISTERED', 'EVENT_CREATED', 'EVENT_UPDATED', 'SPONSOR_CREATED', 'SPONSOR_DELETED', 'INTERACTION_RECORDED', 'LEAD_CREATED', 'USER_CREATED'], required: true, index: true },
